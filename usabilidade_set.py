...
# Podem ser usadas em loops
# Exemplo:
for elemento in lista_concatenada:
    print(elemento)

# Podem ser usadas em condicionais
# Exemplo:
if lista_concatenada[0] == 1:
    print("Primeiro elemento é 1")

# Podem ser usadas como chaves de dicionários
# Exemplo:
dicionario = {lista_concatenada: "Valor"}
print(dicionario) # Saída: {[1, 2, 3, 4, 5, 6]: 'Valor'}

# Podem ser usadas como parâmetros de funções
# Exemplo:
